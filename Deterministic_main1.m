function Results_Grid = Deterministic_main1(y, cost, Grid, Bat, heat, opt, ANZ, NET, mpc, NOD, PROF, LIN, H2)
    ...
    SpConstraints = [SpConstraints,0<=Grid.P_import_cap(1,y)<=10000];
    ...
    % --- Asset Operation Constraints (NON-LOOPED) ---
    ...
    % SpConstraints = [SpConstraints,CHP.P_CHP == 0]; % CHP Disabled
    ...
    SpConstraints = [SpConstraints,0<=Grid.P_import<=Grid.P_import_cap(1,y)];
    ...
    for k = 1:opt.Horizon
         ...
         SpConstraints = [SpConstraints, Grid.P_in(:,k) + ...
             Grid.P_import_IncMatrix.*(Grid.P_import(:,k)) + ... 
         ...
         SpConstraints = [SpConstraints, Grid.Q_in(:,k) + ...
             Grid.Q_import_IncMatrix.*(Grid.Q_import(:,k)) + ... 
